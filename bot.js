...
if (msg.content.toLowerCase() === prefix + '<baku') {
  msg.reply('sikərəm agzıvı ha @hidrometeoroloq agıllı ol. afrikada hava zordu');
      }
if (msg.content.toLowerCase() === prefix + 'sa') {
  msg.reply('adam kimi salam ver göt');
       }
if (msg.content.toLowerCase() === prefix + 'sen sox icive') {
  msg.reply('sikdir');
         }
if (msg.content.toLowerCase() === prefix + 'sikdir') {
  msg.reply('sən sikdir');
       }
if (msg.content.toLowerCase() === prefix + 'sen sikdir') {
  msg.reply('əlim dəmirdə');
         }
if (msg.content.toLowerCase() === prefix + 'nagarsan?') {
  msg.reply('sənə nə aq');
	}
});
